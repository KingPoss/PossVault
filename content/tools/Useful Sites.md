...
## Infrastructure
- [Interactive map of transmission lines](https://www.arcgis.com/apps/mapviewer/index.html?layers=d4090758322c4d32a4cd002ffaa0aa12)
- [Wind Turbine database](https://energy.usgs.gov/uswtdb/viewer/)
- [Interactive map of U.S. Power Plants](https://experience.arcgis.com/experience/bb8c905b75f84d908ab83f579498d085/page/Page) (up to 2023)
## Maps / Feeds
- [Earth in Real Time](https://zoom.earth/maps/satellite/)
- [EOS satellite imagery and analytics](https://eos.com/products/landviewer/)
- [Watch Duty (fire/incident map)](https://app.watchduty.org/)
## Radio
- [Antenna search](https://www.antennasearch.com/)
- [Radio reference database](https://www.radioreference.com/) (login required)
