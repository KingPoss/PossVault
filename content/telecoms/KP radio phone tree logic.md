...
![[phonetree.png |200 ]] Once a caller presses #1, a time condition is checked. If it's too late (10:00 PM to 7:00 AM PST), the caller is sent to a voice mailbox that tells them to call back later, and gives them the option to leave a voicemail.  
